...
namespace CoalStorage.Infrastructure.Data.Migrations
{
    ...
    [Migration("20241118090736_initAddLoadTo")]
    partial class initAddLoadTo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CoalStorage.Core.Entities.AreaPicket", b =>
                {
                    ...
                    b.HasOne("CoalStorage.Core.Entities.Picket", "Picket")
                        .WithOne("AreaPicket")
                        .HasForeignKey("CoalStorage.Core.Entities.AreaPicket", "PicketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
